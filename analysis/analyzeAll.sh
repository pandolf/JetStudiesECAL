...
then
  ...
  ./jseAnalyzer $1  RelValQCD_FlatPt_15_3000_PFthA_noPU
  ./jseAnalyzer $1  RelValQCD_FlatPt_15_3000_PFthB_noPU
  ./jseAnalyzer $1  RelValQCD_FlatPt_15_3000_PFthC_noPU
  #./jseAnalyzer $1 RelValZEE_rel2007_GTv4
  #./jseAnalyzer $1 RelValZEE_rel2008_GTv4
  #./jseAnalyzer $1 RelValZEE_rel2008_GTv7
fi
